package com.example.blooddonar.base
...
open class BaseActivity : AppCompatActivity() {
    ...
    fun popupDisplay(
        ...
        val powerMenu = PowerMenu.Builder(context)
            ...
            .setSelectedMenuColor(ContextCompat.getColor(context, R.color.red))
            .build()
